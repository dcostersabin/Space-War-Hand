...
def game():
    ...
    # window
    window_w = int(monitor_width / 1.75)
    window_h = int(monitor_height / 2)
    ...
    pygame.mixer.music.load("audio/musics/game.mp3")
    ...
    class Boss:
        ...
        def draw_health(self):
            ...
            pygame.draw.rect(window, (220, 0, 220),
                             (window_w - self.healthbar_width - 10, 10, amount, self.healthbar_height))
            if self.hitted == 0:
                pygame.draw.rect(window, white, (
                window_w - self.healthbar_width - 10, 10, self.healthbar_width, self.healthbar_height), 2)
            else:
        ...
        if not game_started:
            ...
            if player.levellock == 0:
                ...
                if player.level == 1:
                    if a_spawndelay == 160:
                        a_spawndelay = 0
                        new_asteroid = Asteroid(which=randrange(1, 3), size=randrange(6, 13), speed=randrange(1, 4),
                                                ytime=randrange(0, 6))
                ...
                if player.level == 2:
                    if a_spawndelay == 100:
                        a_spawndelay = 0
                        new_asteroid = Asteroid(which=randrange(1, 3), size=randrange(5, 12), speed=randrange(2, 4),
                                                ytime=randrange(0, 6))
                        asteroids.append(new_asteroid)
